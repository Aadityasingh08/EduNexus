...
export const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-8 animate-fade-in text-slate-900 dark:text-slate-100">
      {/* Student Academic Command Center Banner */}
      <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-r from-blue-50/90 via-indigo-50/50 to-white dark:from-[#111827] dark:via-[#161F30] dark:to-[#111827] border border-blue-200/80 dark:border-slate-800 shadow-md flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative overflow-hidden transition-all">
        <div className="space-y-2 relative z-10">
          <div className="flex flex-wrap items-center gap-2.5">
            <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">
              Good morning, {studentProfile.name.split(' ')[0]} 👋
            </h1>
            <span className="text-xs px-3 py-1 rounded-full bg-blue-100 dark:bg-blue-500/10 text-blue-700 dark:text-blue-400 border border-blue-300 dark:border-blue-500/20 font-bold">
        ...
        <div className="flex flex-wrap items-center gap-2.5 relative z-10">
          {/* Quick Theme Switcher Pill right on the Dashboard */}
          <button
            onClick={toggleTheme}
            className="px-3.5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 font-bold text-xs flex items-center gap-2 shadow-xs hover:border-blue-500 transition-all active:scale-95 cursor-pointer"
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs shadow-md shadow-blue-600/20 active:scale-95 transition-all flex items-center gap-2"
          >
      ...
      {/* TODAY'S FOCUS & ACADEMIC DIAGNOSTIC ROW */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Today's Priority Focus Card */}
        <div className="lg:col-span-2 p-6 sm:p-7 rounded-3xl bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between hover:border-blue-300 dark:hover:border-slate-700 transition-all">
          <div>
            <div className="flex items-center justify-between mb-4">
              <span className="text-[10px] font-bold uppercase tracking-wider text-blue-700 dark:text-blue-400 bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 px-3 py-1 rounded-full font-mono">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            <button
              onClick={() => navigate('/tutor?topic=Normalization')}
              className="px-6 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs shadow-md shadow-blue-600/20 active:scale-95 transition-all flex items-center gap-2"
            >
        ...
        {/* Academic Diagnostic Insight Card */}
      ...
      {/* QUICK ACTIONS BAR - COLORFUL & ATTRACTIVE */}
      <div>
      ...
      {/* ENROLLED UNIVERSITY COURSES + ADD COURSE */}
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3.5 py-1.5 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-blue-500 bg-white dark:bg-[#111827] text-xs font-bold text-slate-800 dark:text-white flex items-center gap-1.5 transition-colors shadow-xs"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          {courses.map((course) => (
            <div
              key={course.id}
              className="p-5 rounded-3xl bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between hover:border-blue-300 dark:hover:border-slate-700 hover:shadow-md transition-all"
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                  <span className="text-xs font-mono font-bold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 px-2.5 py-1 rounded-lg">
                    {course.code}
                  </span>
              ...
              <button
                ...
                className="w-full py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 hover:bg-blue-600 hover:border-blue-600 hover:text-white text-xs font-bold text-slate-700 dark:text-slate-200 transition-all flex items-center justify-center gap-1.5"
              >
      ...
      {/* UPCOMING STUDY SESSIONS & ACADEMIC RECOMMENDATIONS */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Tasks Checklist */}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 text-[11px] text-slate-500 dark:text-slate-400 mt-0.5">
                      <span className="font-semibold text-blue-600 dark:text-blue-400">{task.subject}</span>
                      <span>•</span>
            ...
            <form onSubmit={handleCreateCourse} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full mt-1 p-3 rounded-xl bg-slate-50 dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 text-xs text-slate-900 dark:text-white placeholder-slate-400 outline-none focus:border-blue-500"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full mt-1 p-3 rounded-xl bg-slate-50 dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 text-xs text-slate-900 dark:text-white outline-none focus:border-blue-500"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full mt-1 p-3 rounded-xl bg-slate-50 dark:bg-[#0F172A] border border-slate-200 dark:border-slate-800 text-xs text-slate-900 dark:text-white placeholder-slate-400 outline-none focus:border-blue-500 resize-none"
                />
              </div>
